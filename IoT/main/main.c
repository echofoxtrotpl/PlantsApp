...
//                       "\n\tSSID     : %s\n\tPassword : %s",
//                  (const char *)cJSON_GetObjectItem(json, "ssid")->valuestring,
//                  (const char *)cJSON_GetObjectItem(json, "password")->valuestring);
//     }
...
//      .characteristics = (struct ble_gatt_chr_def[]){{.uuid = BLE_UUID16_DECLARE(0xFEF0), // Define UUID for reading
//                                                      .flags = BLE_GATT_CHR_F_READ,
//                                                      .access_cb = handle_read_config},
//                                                     {.uuid = BLE_UUID16_DECLARE(0xDEA0), // Define UUID for writing
